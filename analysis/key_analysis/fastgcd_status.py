...
def get_fastgcd_smime_certs_stats(refresh: bool = False):
    cache_name = get_cache_name()
    comment = "SMIME certificates with FastGCD status true"
    ...
    pipeline = [  # ignoriert certificates ohne chain validation result
        {
            "$lookup": {
                "from": "chain",
                "localField": "_id",
...
if __name__ == "__main__":
    ...
    get_fastgcd_smime_certs_stats(refresh=refresh_flag)
